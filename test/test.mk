...
CFLAGS += -D_GNU_SOURCE
test.o: test.c ../package/export.h string-stream.h ../deps/stream/stream.h ../package/index.h ../package/package.h
...
test: test.o ../package/export.o ../deps/stream/stream.o ../utils/utils.o ../package/atomic-stream.o ../package/package.o ../deps/hash/hash.o string-stream.o ../package/index.o ../parser/grammer.o ../parser/parser.o ../lexer/stack.o ../lexer/item.o ../lexer/lex.o ../lexer/buffer.o ../lexer/syntax.o ../parser/import.o ../package/import.o ../parser/string.o ../parser/package.o ../parser/export.o ../parser/identifier.o ../parser/build.o ../deps/stream/file.o
	$(CC) $(CFLAGS) $(LDFLAGS)  test.o ../package/export.o ../deps/stream/stream.o ../utils/utils.o ../package/atomic-stream.o ../package/package.o ../deps/hash/hash.o string-stream.o ../package/index.o ../parser/grammer.o ../parser/parser.o ../lexer/stack.o ../lexer/item.o ../lexer/lex.o ../lexer/buffer.o ../lexer/syntax.o ../parser/import.o ../package/import.o ../parser/string.o ../parser/package.o ../parser/export.o ../parser/identifier.o ../parser/build.o ../deps/stream/file.o -o test $(LDLIBS)

CLEAN_test:
	rm -rf test test.o ../package/export.o ../deps/stream/stream.o ../utils/utils.o ../package/atomic-stream.o ../package/package.o ../deps/hash/hash.o string-stream.o ../package/index.o ../parser/grammer.o ../parser/parser.o ../lexer/stack.o ../lexer/item.o ../lexer/lex.o ../lexer/buffer.o ../lexer/syntax.o ../parser/import.o ../package/import.o ../parser/string.o ../parser/package.o ../parser/export.o ../parser/identifier.o ../parser/build.o ../deps/stream/file.o
